...
set CommonCompilerFlags= /EHsc -MTd -nologo -Gm- -GR- -EHa- -Od -Oi -WX -W4 -wd4201 -wd4100 -wd4189 -wd4456 -FC -Z7 /IC:\z\bin\SDL2-devel-2.0.10-VC\include /IC:\z\bin\SDL2_ttf-2.0.15-VC\include /IC:\z\bin\SDL2_image-2.0.5-VC\include /IC:\z\bin\SDL2_mixer-2.0.4-VC\include /I"C:\Program Files\Microsoft DirectX SDK (June 2010)\Include"

rem Linker Flags

set CommonLinkerFlags= -incremental:no -opt:ref user32.lib gdi32.lib  d3d9.lib comctl32.lib  winmm.lib SDL2.lib SDL2main.lib SDL2_image.lib SDL2_ttf.lib SDL2_mixer.lib /LIBPATH:C:\z\bin\SDL2-devel-2.0.10-VC\lib\x64 /LIBPATH:C:\z\bin\SDL2_ttf-2.0.15-VC\lib\x64 /LIBPATH:C:\z\bin\SDL2_image-2.0.5-VC\lib\x64 /LIBPATH:C:\z\bin\SDL2_mixer-2.0.4-VC\lib\x64 /LIBPATH:"C:\Program Files\Microsoft DirectX SDK (June 2010)\Lib\x86"
